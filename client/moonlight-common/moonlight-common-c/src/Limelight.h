...
typedef struct _STREAM_CONFIGURATION {
    ...
    // Requests Sunshine cursor feedback for Parsec-like mouse handling.
    bool cursorFeedback;
...
#define LI_CURSOR_FLAG_VISIBLE             0x01
#define LI_CURSOR_FLAG_RELATIVE_MODE       0x02
#define LI_CURSOR_FLAG_CLIP_VALID          0x04
#define LI_CURSOR_FLAG_IMAGE_INCLUDED      0x08
#define LI_CURSOR_FLAG_HOST_CURSOR_HIDDEN  0x10

// This callback is invoked when Sunshine sends host cursor state feedback.
// imageData points to premultiplied BGRA cursor bitmap data when imageByteLength is non-zero.
typedef void(*ConnListenerCursorState)(uint8_t version, uint8_t flags, uint32_t sequence,
