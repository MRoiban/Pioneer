...
1. Run the following line in your Terminal:
   ...
   ```
1. Install XCFramework dependencies by downloading [the latest built frameworks](https://github.com/coofdy/moonlight-mobile-deps/releases/download/latest/moonlight-apple-xcframeworks.zip). Unzip that file, and place the `.xcframework` files into the `client/xcframeworks` directory in this repository.

2. Open `client/Moonlight.xcodeproj` in Xcode.
